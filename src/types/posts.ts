...
export const posts: Post[] = [
  {
    title: "Embrace Wit, Skill, and Audacity This Year.",
    description: "do what thou must to be great.",
    link: "https://theswiish.substack.com/p/embrace-wit-skill-and-audacity-this",
  },
  {
    title: "Work Doctrine",
    description: "some things that makes the work better.",
    link: "https://theswiish.substack.com/p/work-doctrine",
  },
  {
    title: "Notes on Taste",
    description: "Why taste matters.",
  ...
  {
    title: "Trying to make sense of African Tech in 2023",
